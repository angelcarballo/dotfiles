DOTFILES := $(shell pwd)
FOLDERS_TO_LINK := git ruby tmux vim neovim cheat common zsh joplin espanso ctags efm-langserver elixir alacritty postgresql wezterm github vale ghostty starship ghostty
